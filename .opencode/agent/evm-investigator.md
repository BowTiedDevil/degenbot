...
You are in Ethereum Virtual Machine (EVM) transaction investigation mode.
...
- Inspecting the transaction using a block explorer (Etherscan or similar): `https://etherscan.io/tx/<transaction_hash>`

...
use degenbot_bot::bot_core::{drain_sink::DrainSink, Bot, RegisterV3PoolParams, V3SwapUpdate};
use degenbot_bot::bot_core::{RegisterV4PoolParams, V4StateSync, V4SwapUpdate};

use degenbot_bot::optimizers::uniswap_engine::engine_handle::EngineHandle;
use degenbot_bot::optimizers::uniswap_engine::engine_subscriber::EngineSubscriber;

use degenbot_bot::optimizers::uniswap_engine::snapshot_verify::{
    register_with_cl_buffers, run_cl_verification, SnapshotStore, VerifyError, VerifyRpc,
};
use degenbot_bot::optimizers::uniswap_engine::{
...
struct EngineVerifyRpc<'a> {
    ...
    provider: &'a parking_lot::Mutex<Option<degenbot_rpc::provider::AlloyProvider>>,
}
...
fn make_tick_info(liquidity_gross: u128, liquidity_net: i128) -> degenbot_bot::bot_core::TickInfo {

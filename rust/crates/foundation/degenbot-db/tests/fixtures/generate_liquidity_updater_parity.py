...
in `rust/crates/foundation/degenbot-db/src/liquidity_updater.rs`).
...
Run once (or whenever the seed/event sequence should change)::
    ...
    uv run python rust/crates/foundation/degenbot-db/tests/fixtures/generate_liquidity_updater_parity.py

Outputs (committed):
    rust/crates/foundation/degenbot-db/tests/fixtures/liquidity_updater_v3_initial.db
    rust/crates/foundation/degenbot-db/tests/fixtures/liquidity_updater_v3_expected.json
    rust/crates/foundation/degenbot-db/tests/fixtures/liquidity_updater_v4_initial.db
    rust/crates/foundation/degenbot-db/tests/fixtures/liquidity_updater_v4_expected.json
"""

...
Run once (or whenever the seed data should change)::
    ...
    uv run python rust/crates/foundation/degenbot-db/tests/fixtures/generate_aave_parity.py

Outputs (committed):
    rust/crates/foundation/degenbot-db/tests/fixtures/aave_parity.db
    rust/crates/foundation/degenbot-db/tests/fixtures/aave_parity_expected.json
"""

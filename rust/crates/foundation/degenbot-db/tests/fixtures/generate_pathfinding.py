...
Run once (or whenever the seed data should change)::
    ...
    uv run python rust/crates/foundation/degenbot-db/tests/fixtures/generate_pathfinding.py

Outputs (committed-ish — the .db is gitignored, regenerate locally):
    rust/crates/foundation/degenbot-db/tests/fixtures/pathfinding.db
    rust/crates/foundation/degenbot-db/tests/fixtures/pathfinding_expected.json
"""
...
_POOL_KIND_V2 = 0
# Mirrors Rust `V4_POOL_ID_OFFSET` (crates/foundation/degenbot-db/src/pathfinding.rs):

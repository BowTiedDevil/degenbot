...
//! `concentrated_liquidity_math` module (`rust/crates/shells/degenbot-python/src/concentrated_liquidity_math/`),
//! which imports this crate directly (no re-export alias).
//!
//! # Architecture
//!
//! Each module mirrors a Solidity library file and exposes pure functions
...
//! ├── liquidity_mapping.rs — tick bitmask mapping

// AUTO-GENERATED by tests/fixtures/generate_composers_parity.py.
// Byte-exact parity vs the Python oracle:
//   - examples/eth_backrun_helpers.py::encode_cmd_stream (the 2-hop + V2N dispatch)
...
#[test]
fn parity_v3v4_v4_in_native() {
    // Python oracle returned None — unsupported path.
    let rust = None;
    let py: Option<Vec<u8>> = None;
    assert_eq!(rust, py);
}

            ...
            _ => {
                ...
                match (facts[0].prot, facts[1].prot, facts[2].prot) {
                    ...
                    (Prot::V2, Prot::V2, Prot::V4) => {
                        ...
                        let b_step =
                            mechanics::v2_swap(&mut at, fb, c_swap_in, pm_idx, None, false)?;
                        let inner: Plan = vec![
                            PlanStep::V4Sync {
                                currency_idx: forward_b,
                                currency_addr: fwd_b,
                    ...
                    (Prot::V2, Prot::V4, Prot::V4) => {
                        ...
                        let a_step =
                            mechanics::v2_swap(&mut at, fa, b_swap_in, pm_idx, None, false)?;
                        let inner: Plan = vec![
                            PlanStep::V4Sync {
                                currency_idx: forward_a,
                                currency_addr: forward_a_cur,
                    ...
                    (Prot::V2, Prot::V4, Prot::V3) => {
                        ...
                        let a_step =
                            mechanics::v2_swap(&mut at, fa, v4_swap_in, pm_idx, None, false)?;
                        let v4_inner: Plan = vec![
                            PlanStep::V4Sync {
                                currency_idx: forward_a,
                                currency_addr: forward_a_cur,

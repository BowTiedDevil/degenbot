...
impl V4PoolState {
    ...
    pub fn build_int_v4_sequence(
        ...
        // `v4_simulate_swap` + the sim_v4_swap_step_rounding diagnosis (removed in the stale-docs cleanup `71ec78b2`).
...
pub fn v4_simulate_swap(
    ...
    // (the V4-only divergence pinned in the sim_v4_swap_step_rounding
    // diagnosis, removed in the stale-docs cleanup `71ec78b2`). `fee` here is the

//! `PyO3` seam for the Aave V3 position read-back. A thin `#[pyclass]`
//! `PyDatabasePositionQuery` holding a [`DegenbotDb`] read handle, exposing
//! the [`degenbot_db::aave`] read fns to Python.
//!

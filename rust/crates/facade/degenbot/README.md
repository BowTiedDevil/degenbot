...
The in-package example `examples/standalone_consumer.rs` (in-repo: `rust/crates/facade/degenbot/examples/standalone_consumer.rs`) is a complete pure-Rust consumer of this crate — start there to see the full surface in one file.

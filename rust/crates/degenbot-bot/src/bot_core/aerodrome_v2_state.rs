...
//! as V2 — so the reorg journal reuses [`crate::bot_core::state_history::V2BlockDelta`]
...
/// it up via [`crate::bot_core::BotState::get_aerodrome_identity`]. The two
/// are paired in [`crate::bot_core::PoolEntry::AerodromeV2`].
#[derive(Clone, Debug)]
...
impl AerodromeV2PoolState {
    ...
    /// [`crate::bot_core::BotState::aerodrome_restore_before_block`] can land

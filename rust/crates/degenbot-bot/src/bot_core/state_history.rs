...
//! Re-exported here at the historical `bot_core::state_history` path so consumers
//! resolve unchanged. Transient re-export — repointed at
//! `degenbot_pools::state_history` natively by USPN7M/P2CKRL.

pub use ::degenbot_pools::state_history::*;

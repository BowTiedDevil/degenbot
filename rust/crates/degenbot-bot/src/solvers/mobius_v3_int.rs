...
pub fn int_solve_v3_v3(
    ...
    if seq1.ranges.len() == 1 && seq2.ranges.len() == 1 {
        ...
        let result = crate::solvers::mobius_int_exact::exact_mobius_solve(&[hop1, hop2]).ok()?;
    ...
    for k1 in 0..n1 {
        for k2 in 0..n2 {
            ...
            let Ok(result) = crate::solvers::mobius_int_exact::exact_mobius_solve(&[hop1, hop2])
            else {
                continue;
            };
...
pub fn int_solve_cl_path(sequences: &[&IntV3TickRangeSequence]) -> Option<(U256, U256, Vec<U256>)> {
    ...
    if all_single {
        let flat_hops: Vec<IntHopState> = sequences
            ...
            .collect();
        let result = crate::solvers::mobius_int_exact::exact_mobius_solve(&flat_hops).ok()?;
...
pub fn compute_mixed_int_mobius_coefficients(
    ...
    crate::solvers::mobius_int::compute_int_mobius_coefficients(&flat_hops).ok()
}
...
fn u512_to_u256(v: U512) -> U256 {
    crate::solvers::mobius_int_exact::u512_to_u256_internal(v)
}

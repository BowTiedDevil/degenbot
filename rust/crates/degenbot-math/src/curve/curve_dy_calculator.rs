...
//! [`crate::curve::stableswap`]; no I/O and no `pyo3`, so a standalone `cargo add
...
pub struct DyCalculationInputs {
    ...
    pub y_variant: crate::curve::stableswap::YVariant,
...
pub fn resolve_amp(
    raw_a: U256,
    a_precision: U256,
    y_variant: crate::curve::stableswap::YVariant,
) -> U256 {
    if y_variant == crate::curve::stableswap::YVariant::Variant0 {
        raw_a / a_precision
    } else {
        raw_a
    }

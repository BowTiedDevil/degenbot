...
//! [`crate::solidly::SolidlyMathError::Overflow`] on every multiplication that
...
use crate::solidly::{SolidlyMathError, ONE};
...
/// ([`crate::solidly::calc_exact_in_stable_camelot`]) uses `k_camelot` /
/// `get_y_camelot`.
///
/// # Errors
///

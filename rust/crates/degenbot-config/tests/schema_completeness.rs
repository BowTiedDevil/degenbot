...
const SWEEP_ARTIFACTS: &[&str] = &[
    ...
    "DEGENBOT_V",
    // the family wildcard in the facet-invariant test's prefix assertion
    // (the schema owns the concrete DEGENBOT_STRATEGY_BACKRUN_* keys).
    "DEGENBOT_STRATEGY_BACKRUN_",

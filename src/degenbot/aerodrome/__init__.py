...
_chain_id = 8453
_v3_deployment = FACTORY_DEPLOYMENTS.get(_chain_id, {}).get(
    get_checksum_address(_v3_factory_address)
)
...
_v2_deployment = FACTORY_DEPLOYMENTS.get(_chain_id, {}).get(
    get_checksum_address(_v2_factory_address)
)
pool_type_registry.register(
    AerodromeV2Pool,
    chain_id=_chain_id,

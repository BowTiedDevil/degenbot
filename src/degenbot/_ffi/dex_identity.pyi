"""Stub for the dynamically-created ``degenbot._ffi.dex_identity`` submodule.

Created at runtime by ``add_dex_identity`` in the PyO3 wrapper crate
(``degenbot-python/src/bot/dex_identity.rs``). Holds the DEX identity
preset lookup function + the frozen PyDexIdentity view.
"""
...
__all__ = ["PyDexIdentity", "dex_identity"]

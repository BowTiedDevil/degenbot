...
class PyBotIo:
    ...
    delegates the RPC surface to the held ``ProviderAdapter`` so any backend
    (web3 / alloy / offline) works unchanged. The calling convention is
    positional leading args + ``block=`` kwarg.
    """
    ...
    def fetch_erc20_metadata(self, address: str) -> tuple[str, str, int] | None: ...
    def fetch_erc20_string_field(
        self, address: str, signature: str, block: int | None = None
    ) -> str: ...
    def fetch_erc20_uint_field(
        self, address: str, signature: str, block: int | None = None
    ) -> int: ...
    ...
    def fetch_v3_immutable_data(
        self, pool_address: str, block: int | None = None
    ) -> tuple[ChecksumAddress, ChecksumAddress, ChecksumAddress, int, int]: ...
    ...
    def fetch_camelot_state(
        self, pool_address: str, block: int | None = None
    ) -> tuple[bool, int, int, int]: ...
    def fetch_aerodrome_v2_stable_and_fee(
        self, pool_address: str, factory_address: str, block: int | None = None
    ) -> tuple[bool, int]: ...
    def fetch_curve_balances(
        self, pool_address: str, count: int, block: int | None = None
    ) -> list[int]: ...
    def fetch_curve_pool_params(
        self, pool_address: str, block: int | None = None
    ) -> tuple[int, int, int]: ...

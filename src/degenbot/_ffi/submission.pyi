...
class Dispatcher:
    ...
    def block_timestamp_for(self, block: int) -> int | None: ...
    ...
    # ── divergence / FoT monitoring (GMWYIU + 3O535Q) ──
    @property
    def total_divergent_dropped(self) -> int: ...
    @property
    def total_fot_dropped(self) -> int: ...
    def fot_tokens(self, current_block: int) -> list[str]: ...
    def set_fot_verified_non_fot(self, tokens: list[str]) -> None: ...
    def divergent_pools(self, current_block: int) -> list[DivergentPool]: ...

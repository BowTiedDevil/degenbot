...
_DEPRECATED_CLASS_NAMES: dict[str, str] = {
    "UniswapLpCycle": (
        "degenbot.arbitrage._legacy._uniswap_lp_cycle:_UniswapLpCycle"
    ),
    "UniswapCurveCycle": (
        "degenbot.arbitrage._legacy._uniswap_curve_cycle:_UniswapCurveCycle"
    ),
    "_UniswapMultiPoolCycleTesting": (
        "degenbot.arbitrage._legacy._uniswap_multipool_cycle_testing"
        ":_UniswapMultiPoolCycleTesting"
    ),
    "_UniswapTwoPoolCycleTesting": (
        "degenbot.arbitrage._legacy._uniswap_2pool_cycle_testing"
        ":_UniswapTwoPoolCycleTesting"
    ),
    "_UniswapLpCycle": (
        "degenbot.arbitrage._legacy._uniswap_lp_cycle:_UniswapLpCycle"

...
# BalancerQueries — verified against Balancer's official mainnet deployment
# table (docs-v2.balancer.fi) + on-chain bytecode. Used by the on-chain
# parity tests as the oracle for pool metadata.

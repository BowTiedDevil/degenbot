...
CURVE_V1_POOL_ABI: List[Any] = ujson.loads(
    """
...
CURVE_V2_POOL_ABI: List[Any] = ujson.loads(
    """
    [
  {
    "name": "TokenExchange",
...
CURVE_METAREGISTRY_ABI: List[Any] = ujson.loads(
    """
...
CURVE_V1_REGISTRY_ABI: List[Any] = ujson.loads(
    """
...
CURVE_V1_FACTORY_ABI: List[Any] = ujson.loads(
    """

...
CURVE_V1_POOL_ABI: list[Any] = json.loads(
    """
...
CURVE_V2_POOL_ABI: list[Any] = json.loads(
    """
    [
  {
    "name": "TokenExchange",
...
CURVE_METAREGISTRY_ABI: list[Any] = json.loads(
    """
...
CURVE_V1_REGISTRY_ABI: list[Any] = json.loads(
    """
...
CURVE_V1_FACTORY_ABI: list[Any] = json.loads(
    """

...
SINGLETON_REGISTRATIONS: dict[tuple[int, str], tuple[type, str | None, str]] = {
    ...
    (1, "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f"): (
        UniswapV2Pool, None, "uniswap_v2"
    ),
    (1, "0x1F98431c8aD98523631AE4a59f267346ea31F984"): (
        UniswapV3Pool, None, "uniswap_v3"
    ),
    (1, "0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac"): (
        SushiswapV2Pool, "sushiswap", "sushiswap_v2"
    ),
    (1, "0xbACEB8eC6b9355Dfc0269C18bac9d6E2Bdc29C4F"): (
        SushiswapV3Pool, "sushiswap", "sushiswap_v3"
    ),
    (1, "0x1097053Fd2ea711dad45caCcc45EfF7548fCB362"): (
        PancakeswapV2Pool, "pancakeswap", "pancakeswap_v2"
    ),
    (1, "0x0BFbCF9fa4f9C56B0F40a671Ad40E0805A091865"): (
        PancakeswapV3Pool, "pancakeswap", "pancakeswap_v3"
    ),
    # Base
    ...
    (8453, "0x5e7BB104d84c7CB9B682AaC2F3d509f5F406809A"): (
        AerodromeV3Pool, "aerodrome", "aerodrome_v3"
    ),
    (8453, "0x420DD381b31aEf6683db6B902084cB0FFECe40Da"): (
        AerodromeV2Pool, "aerodrome", "aerodrome_v2"
    ),
    (8453, "0x04C9f118d21e8B767D2e50C946f0cC9F6C367300"): (
        SwapbasedV2Pool, "swapbased", "swapbased_v2"
    ),
    # Arbitrum
    ...
    (42161, "0x6EcCab422D763aC031210895C81787E87B43A652"): (
        CamelotLiquidityPool, "camelot", "camelot_v2"
    ),
}
...
class TestDeploymentDataMatchesFactoriesModule:
    ...
    def test_init_hash_matches_factories_module(
        self, chain_id: int, factory: str
    ) -> None:
    ...
    def test_deployer_matches_factories_module(
        self, chain_id: int, factory: str
    ) -> None:

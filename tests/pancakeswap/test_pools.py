...
PANCAKE_V2_ROUTER = to_checksum_address("0x8cFe327CEc66d1C090Dd72bd0FF11d690C33a2Eb")
PANCAKE_V2_ROUTER_ABI = orjson.loads(
    """
...
def test_pools() -> Any:
    return orjson.loads(
        pathlib.Path("tests/pancakeswap/first_200_pancakeswap_v2_pools.json").read_text()
    )

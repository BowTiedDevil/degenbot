...
class TestCalcDp:
    ...
    def test_variant_alpha_step(self):
        result = calc_dp_variant_alpha(
            d=2_000_000, d_p=1_000_000, xp=[1_000_000, 1_000_000], n_coins=2
        )
        assert result > 0
...
class TestStableswapGetD:
    ...
    def test_zero_balances(self):
        ...
        d = stableswap_get_d(
            [0, 0], amp=100, n_coins=2, a_precision=100, d_variant=DVariant.STANDARD
        )
        assert d == 0
    ...
    def test_variant_alpha(self):
        ...
        xp = [2_000_000_000_000_000_000, 1_000_000_000_000_000_000]
        d = stableswap_get_d(
            xp, amp=100, n_coins=2, a_precision=100, d_variant=DVariant.VARIANT_ALPHA
        )
    ...
    def test_variant_alpha_dp_alpha(self):
        ...
        xp = [2_000_000_000_000_000_000, 1_000_000_000_000_000_000]
        d = stableswap_get_d(
            xp, amp=100, n_coins=2, a_precision=100, d_variant=DVariant.VARIANT_ALPHA_DP_ALPHA
        )
        assert d == 2_998_146_985_239_894_576
    ...
    def test_variant_dp_alpha(self):
        ...
        xp = [2_000_000_000_000_000_000, 1_000_000_000_000_000_000]
        d = stableswap_get_d(
            xp, amp=100, n_coins=2, a_precision=100, d_variant=DVariant.VARIANT_DP_ALPHA
        )
    ...
    def test_variant_beta_dp(self):
        ...
        xp = [2_000_000_000_000_000_000, 1_000_000_000_000_000_000]
        d = stableswap_get_d(
            xp, amp=100, n_coins=2, a_precision=100, d_variant=DVariant.VARIANT_BETA_DP
        )
        assert d == 2_912_328_492_271_816_922
    ...
    def test_variant_gamma_dp(self):
        ...
        xp = [2_000_000_000_000_000_000, 1_000_000_000_000_000_000]
        d = stableswap_get_d(
            xp, amp=100, n_coins=2, a_precision=100, d_variant=DVariant.VARIANT_GAMMA_DP
        )
    ...
    def test_higher_amplification_closer_to_sum(self):
        ...
        xp = [2_000_000_000_000_000_000, 1_000_000_000_000_000_000]
        d_low_a = stableswap_get_d(
            xp, amp=100, n_coins=2, a_precision=100, d_variant=DVariant.STANDARD
        )
        d_high_a = stableswap_get_d(
            xp, amp=1000, n_coins=2, a_precision=100, d_variant=DVariant.STANDARD
        )
...
class TestStableswapGetY:
    ...
    def test_y_variant_1(self):
        ...
        y = stableswap_get_y(
            ...
            amp=10000,
            n_coins=2,
            a_precision=100,  # amp=100*100 for VARIANT_1
            y_variant=YVariant.VARIANT_1,
            d_variant=DVariant.STANDARD,
        )
        assert y > 0
...
class TestStableswapGetYD:
    ...
    def test_variant_0(self):
        ...
        y_d = stableswap_get_y_d(
            ...
            n_coins=2,
            a_precision=100,
            yd_variant=YDVariant.VARIANT_0,
        )
        assert y_d > 0

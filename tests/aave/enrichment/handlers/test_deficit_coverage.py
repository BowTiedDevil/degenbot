"""Tests for DEFICIT_COVERAGE operation handler."""
...
class TestDeficitCoverageHandler:
    ...
    @pytest.fixture
    def handler(self) -> DeficitCoverageHandler:
        return DeficitCoverageHandler()

    def test_handler_supports_deficit_coverage_operation(
    ...
    def test_deficit_coverage_transfer_uses_amount_directly(
        ...
        operation = _create_mock_operation(OperationType.DEFICIT_COVERAGE)
    ...
    def test_deficit_coverage_burn_calculates_scaled_amount(
        ...
        operation = _create_mock_operation(OperationType.DEFICIT_COVERAGE, pool_event)
        context = _create_mock_context_for_burn()

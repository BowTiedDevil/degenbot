 ...
 * @dev Extracted from Pool/rev_9.sol - this is the TokenMath library for Pool revisions 9+.
 * @dev Functionally identical to Rev 4 TokenMath, but extracted from Pool contract for completeness.
 */
library TokenMath {

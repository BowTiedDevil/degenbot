...
@hypothesis.given(
    tick=hypothesis.strategies.integers(min_value=MIN_INT24, max_value=MAX_INT24),
    tick_spacing=hypothesis.strategies.integers(min_value=MIN_INT24, max_value=MAX_INT24),
)

...
@pytest.fixture
def eth_usdc_v4() -> UniswapV4Pool:
    """I/O-free ETH/USDC V4 pool recorded at ``_V4_ETH_USDC_BLOCK`` (no RPC)."""
    pool = load_pool(_V4_ETH_USDC_GOLDEN, chain_id=1, block=_V4_ETH_USDC_BLOCK)

...
@pytest.fixture
def mocked_wbtc_weth_v3liquiditypool():
...
def test_external_update(mocked_wbtc_weth_v3liquiditypool) -> None:
    ...
    assert lp.tick_data[-887160].liquidityGross == 80064092962998 + new_liquidity
    assert lp.tick_data[-887220].liquidityGross == 82174936226787 + new_liquidity

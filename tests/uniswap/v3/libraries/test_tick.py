...
def test_tickSpacingToMaxLiquidityPerTick():
    maxLiquidityPerTick = Tick.tickSpacingToMaxLiquidityPerTick(TICK_SPACINGS[FEE_AMOUNT["HIGH"]])
    ...
    maxLiquidityPerTick = Tick.tickSpacingToMaxLiquidityPerTick(TICK_SPACINGS[FEE_AMOUNT["LOW"]])
    ...
    maxLiquidityPerTick = Tick.tickSpacingToMaxLiquidityPerTick(TICK_SPACINGS[FEE_AMOUNT["MEDIUM"]])

...
# evaluated against the results from the Uniswap V3 Quoter contract
# functions `quoteExactOutputSingle` and `quoteExactInputSingle`
#
...
lp._pool_state_archive = {lp._update_block: lp.state}
...
def test_pool_state_equality() -> None:
    with pytest.raises(AssertionError):
...
def test_calculate_tokens_out_from_tokens_in() -> None:
    assert (
...
def test_calculate_tokens_out_from_tokens_in_with_override() -> None:
...
def test_calculate_tokens_in_from_tokens_out() -> None:
    assert (
...
def test_calculate_tokens_in_from_tokens_out_with_override() -> None:
    # Overridden reserve values for this test are taken at block height 17,650,000
    # Liquidity: 1533143241938066251
    # SqrtPrice: 31881290961944305252140777263703426
    # Tick: 258116
...
def test_simulations_with_override() -> None:
    # Overridden reserve values for this test are taken at block height 17,650,000
    # Liquidity: 1533143241938066251
    # SqrtPrice: 31881290961944305252140777263703426
    # Tick: 258116
...
def test_external_updates() -> None:
    lp.external_update(
        update=UniswapV3PoolExternalUpdate(
            block_number=2,
            liquidity=69,

...
def test_v3_liquidity_pool_calculate_tokens_out_from_tokens_in():
    ...
    assert (
        ...
        == -simulated_state_1["amount0_delta"]
    )
    assert weth_amount_in == simulated_state_1["amount1_delta"]
    ...
    assert (
        ...
        == -simulated_state_2["amount1_delta"]
    )
    assert wbtc_amount_in == simulated_state_2["amount0_delta"]

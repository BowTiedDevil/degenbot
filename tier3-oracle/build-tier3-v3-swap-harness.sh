...
# Ensure the canonical v3-core reference source is present (idempotent;
...
mkdir -p "${OUT_DIR}/V3SwapOracleHarness.sol"
python3 - "${RAW}" "${OUT_DIR}/V3SwapOracleHarness.sol/V3SwapOracleHarness.json" <<'PY'
import json, sys
